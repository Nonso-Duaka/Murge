...
export function BudgetCalculatorScreen({ onBack }: BudgetCalculatorScreenProps) {
  ...
  const categories = [
    { id: 'income', label: 'Income', icon: '💰', color: 'bg-green-500/20 text-green-400' },
    { id: 'housing', label: 'Housing', icon: '🏠', color: 'bg-blue-500/20 text-blue-400' },
    { id: 'utilities', label: 'Utilities', icon: '⚡', color: 'bg-yellow-500/20 text-yellow-400' },
    { id: 'transportation', label: 'Transportation', icon: '🚇', color: 'bg-purple-500/20 text-purple-400' },
    { id: 'food', label: 'Food', icon: '🍔', color: 'bg-orange-500/20 text-orange-400' },
    { id: 'personal', label: 'Personal', icon: '🛍️', color: 'bg-pink-500/20 text-pink-400' },
    { id: 'savings', label: 'Savings', icon: '🏦', color: 'bg-cyan-500/20 text-cyan-400' },
  ];
  ...
  return (
    <div className="min-h-screen bg-transparent pb-24 relative z-10">
      ...
      <div className="px-4 sm:px-6 py-6 max-w-2xl mx-auto space-y-4">
        {/* Spending Chart */}
        <div
          className={`bg-white/10 backdrop-blur-xl rounded-2xl p-4 border border-white/20 transition-all duration-500 ${
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <span className={`text-lg font-bold ${
                    category.id === 'income' ? 'text-green-400' : 'text-white'
                  }`}>
