...
export function DashboardScreen({ cityName = 'San Francisco', onOpenProfile, onOpenSearch, onOpenNotifications, onOpenChecklist, onOpenBudget, onOpenActivityFeed }: DashboardScreenProps) {
          ...
          <Card padding="lg" className="bg-white/10 backdrop-blur-3xl text-white border border-white/20 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-3 gap-3">
                <button className="py-3 px-3 bg-white text-black rounded-xl text-xs font-bold hover:bg-white/90 transition-all text-center shadow-lg flex items-center justify-center gap-1.5">
                ...
                <button
                  ...
                  className="py-3 px-3 bg-black/40 border border-white/20 text-white rounded-xl text-xs font-bold hover:bg-black/60 transition-all text-center backdrop-blur-md flex items-center justify-center gap-1.5"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="flex items-center justify-between mb-6 px-1">
            ...
            <button
              ...
              className="text-xs text-white/70 font-bold uppercase tracking-widest hover:text-white transition-all bg-white/10 px-3 py-1 rounded-full"
            >
              View all
            </button>
          </div>
